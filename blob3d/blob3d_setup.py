...
class blob3d_setup:
    def __init__(self, path = None):
        ...
        self.key_float_val = ['nx', 'ny', 'nz', 'xmin', 'ymin', 'zmin', 'xmax', 'ymax', 'zmax', \
            't_start', 't_end', 'dt', 'outputinterval', 'diaginterval', 'kappa_perp', \
            'kappa_par', 'mu', 'theta', 'gaussamp', 'gaussxwidth', 'gaussywidth', 'gausszwidth', \
            'gaussxcenter', 'gaussycenter', 'gausszcenter', 'gaussbglevel', \
    ...
    def set_key(self, key, value):
        ...
        if name in self.key_string_val:
            assert type(key) is str
        elif name in self.key_float_val:
    ...
    def write_blob3dsetup(params, path):
        try:
